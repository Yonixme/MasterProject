...
import com.example.masterproject.screens.EventConsumer
import com.example.masterproject.screens.ExchangeRateRoute
import com.example.masterproject.screens.LocalNavController
import com.example.masterproject.screens.exchangerate.edititem.EditItemViewModel.ScreenState
...
fun EditItemScreen(){
    ...
    EventConsumer(viewModel.exitChannel) {
        if (navController.currentBackStackEntry?.destination?.route == EditRoute){
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                ...
                title = {
                    Text(
                        text = stringResource(R.string.edit_menu),
                        fontSize = 32.sp,
                    )
                },
                navigationIcon = {
